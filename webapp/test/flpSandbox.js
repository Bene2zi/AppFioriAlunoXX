		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aluno XX",
									"targetURL": "#AppFioriAlunoXXappfiorialunoxx-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"AppFioriAlunoXXappfiorialunoxx-display": {
								"semanticObject": "AppFioriAlunoXXappfiorialunoxx",
								"action": "display",
								"description": "Aluno XX Fiori Application",
								"title": "Aluno XX",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=AppFioriAlunoXX.appfiorialunoxx",
									"url": sap.ui.require.toUrl("AppFioriAlunoXX/appfiorialunoxx")
								}
							}
						}
					}
